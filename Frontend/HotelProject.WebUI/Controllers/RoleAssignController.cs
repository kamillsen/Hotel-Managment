...
namespace HotelProject.WebUI.Controllers
{
    public class RoleAssignController : Controller
    {
        ...
        public async Task<IActionResult> AssignRole(int id)
        {
            ...
            var userRoles = await _userManager.GetRolesAsync(user); //! kullanıcının sahip olduğu rollerin bir listesini döndürür
        ...
        {
            //! Identity kütüphanesi sayesinde işlemler kolaylaşıyor
